...
//1341820/1315552/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "ATA6561-GAQW-N" (originalName "ATA6561-GAQW-N")
	...
	(compDef "ATA6561-GAQW-N" (originalName "ATA6561-GAQW-N") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "8" (pinName "STBY") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "ATA6561-GAQW-N"))
		...
		(attr "Mouser Part Number" "579-ATA6561-GAQW-N")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Microchip-Technology/ATA6561-GAQW-N?qs=y6ZabgHbY%252BwGbm2JCZMHKQ%3D%3D")
		(attr "Manufacturer_Name" "Microchip")
		(attr "Manufacturer_Part_Number" "ATA6561-GAQW-N")
		(attr "Description" "MICROCHIP - ATA6561-GAQW-N - CAN TRANSCEIVER, 5MBPS, -40 TO 150DEG C")
		(attr "<Hyperlink>" "http://ww1.microchip.com/downloads/en/DeviceDoc/ATA6560-ATA6561-High-Speed-CAN-Transceiver-DS20005991A.pdf")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "ATA6561-GAQW-N.stp")
