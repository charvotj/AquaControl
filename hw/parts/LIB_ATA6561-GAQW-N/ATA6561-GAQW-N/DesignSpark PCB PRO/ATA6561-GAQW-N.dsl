...
(library Library_1
	...
	(compDef "ATA6561-GAQW-N" (originalName "ATA6561-GAQW-N") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "8" (pinName "STBY") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "http://ww1.microchip.com/downloads/en/DeviceDoc/ATA6560-ATA6561-High-Speed-CAN-Transceiver-DS20005991A.pdf")
		(attr "Height" "1.75 mm")
	)
