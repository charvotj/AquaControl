\section{Technické vybavení akvária}
    ...
    \subsection{Monitorování}
        ...
        \subsubsection{pH a CO\(\mathbf{_{2}}\)}
            ...
            K měření pH vody se používají různé chemické testy (kapkové testy, testovací papírky), které je možné zakoupit v chovatelských potřebách. Z pohledu automatizace je mnohem zajímavějším řešením pH sonda, která umožňuje nepřetržité měření této veličiny a případnou okamžitou regulaci dávkování CO\(_{2}\).
