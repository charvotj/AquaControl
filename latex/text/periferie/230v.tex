...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\textwidth]{obrazky/foto/rele1.jpeg}
    \caption{Relé modul spolu s~expandérem pinů.}
