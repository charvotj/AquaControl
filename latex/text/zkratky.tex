...
\begin{acronym}[iotasdasdsd]
	...
	\acro{vcc}[VCC]{Voltage at the Common Collector -- symbol pro kladné napájecí napětí}
	\acro{vdd}[VDD]{Voltage Drain Drain -- symbol pro kladné napětí zařízení}
	...
	\acro{emc}[EMC]{Elektro magnetická kompatibilita}
	\acro{json}[JSON]{JavaScript Object Notation -- formát ukládání a přenosu strukturovaných dat}
	\acro{rtc}[RTC]{Real Time Clock -- označení reálného času}
